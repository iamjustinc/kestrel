      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white/80 backdrop-blur-xl border border-[#3C4166]/10 rounded-2xl p-8 shadow-xl shadow-[#3C4166]/5">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-semibold text-[#3C4166] mb-2">Welcome back</h1>
            <p className="text-[#6B6F8E]">Sign in to continue your career journey</p>
          </div>
          ...
          <form className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link href="/forgot-password" className="text-sm text-[#4FA7A7] hover:text-[#4FA7A7]/80 transition-colors">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
          ...
          <p className="text-center text-sm text-[#6B6F8E] mt-6">
            ...
            <Link href="/sign-up" className="text-[#4FA7A7] font-medium hover:text-[#4FA7A7]/80 transition-colors">
              Sign up
            </Link>
          </p>
        </div>
